# -*- coding: utf-8 -*-
"""txn_to_wallet_tests.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17ztIil_NqDeX45q_FZxs743qi5NMdmWr
"""

class testparsePublicKeys(unittest.TestCase):
    ...
    "multisigtest": {
        ...
        for test_name, test_case in specScripts.items():
            with self.subTest(test=test_name):
                result = parsePublicKeys(test_case['script_asm'], test_case['txn_type'])
