...
1.) Making the SQL portion more generalizable.
2.) Significantly abstracting away the details by creating master functions. This will make the library far easier to learn.
3.) Add different clustering heuristics such as temporal clustering.
4.) Brush up unit tests and post them to the tests file.
